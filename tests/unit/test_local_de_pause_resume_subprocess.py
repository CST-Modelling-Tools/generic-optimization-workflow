...
def test_de_pause_resume_survives_real_process_restart(
    tmp_path: Path,
) -> None:
...
'''.lstrip(),
    ...
    config = {
        "id": "de-real-process-resume-test",
        ...
        json.dumps(
            {
                "schema_version": 1,
                "action": "pause",
                "request_id": "real-process-pause-0001",
            },
            indent=2,
            sort_keys=True,
        ),
